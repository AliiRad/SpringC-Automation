...
document.addEventListener("DOMContentLoaded", function() {
    let editButtonJobs = document.querySelectorAll('.editButtonJobs');
    ...
    editButtonJobs.addEventListener('click', function(event) {
...
document.addEventListener("DOMContentLoaded", function() {
    let deleteButtonJobs = document.querySelector('.deleteButtonJobs');
